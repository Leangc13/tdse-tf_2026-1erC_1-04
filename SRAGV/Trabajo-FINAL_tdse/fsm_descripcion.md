...
stateDiagram-v2
    ...
    MODO_NORMAL --> MODO_SET_UP : BTN_ENTER
    MODO_SET_UP --> MODO_NORMAL : BTN_ENTER
    
    MODO_NORMAL --> MODO_FALLA : Viento > CRI_TH
    MODO_SET_UP --> MODO_FALLA : Viento > CRI_TH
    
    MODO_FALLA --> MODO_NORMAL : Viento < CRI_TH
```
